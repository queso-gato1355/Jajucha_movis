...
class Planning(BasePlanning):
    ...
    def process(self, t, frontImage, rearImage, frontLidar, rearLidar):
        ...
        points = np.float32([(170, 250), (self.vars.wT-170, 250),(-750 , 640), (self.vars.wT+750, 640)])
        ...
        imgWarpnoCanny = utlis.warpImg(frontImage.copy(),points,self.vars.wT, self.vars.hT)
        cv2.imshow('Warped Image', imgWarpnoCanny)

        imgWarpOriginal = utlis.warpImg(canny.copy(), points, self.vars.wT, self.vars.hT)
        cv2.imshow('Canny Warped Image', imgWarpOriginal)
