...
class Planning(BasePlanning):
    ...
    def process(self, t, frontImage, rearImage, frontLidar, rearLidar):
        ...
        if line[0] == 'right':              # line 이 우차선이면
            ...
            print('line(', self.vars.image_line_detect_x_value_right, ')', line(self.vars.image_line_detect_x_value_right)) # (2) [No 450]의 적절한 값을 넣어주세요.
            ...
            print('line(', self.vars.image_line_detect_x_value_left, ')', line(self.vars.image_line_detect_x_value_left)) # (2) [No 450]의 적절한 값을 넣어주세요.
            print('center_x=', center_x, 'e=', e)
            for i in range(200, 480, 20):
                cv2.circle(laneImage, (int(line(i)), i), 5, (255, 0, 0), -1)
            # cv2.circle(frontImage, (int(f(400)), 400), 5, (255, 0, 0), -1)
        ...
        print("self.vars.steer : ", self.vars.steer)
